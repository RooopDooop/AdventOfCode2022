def main():
    ...
    with open("../inputData.txt", "r") as objFile:
        while True:
            ...
            if baseScheduleLow >= targetScheduleLow and baseScheduleHigh <= targetScheduleHigh:
                totalCount += 1
            elif baseScheduleLow <= targetScheduleLow and baseScheduleHigh >= targetScheduleHigh:
                totalCount += 1
